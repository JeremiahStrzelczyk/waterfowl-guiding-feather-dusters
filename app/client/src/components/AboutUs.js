        ...
        <Container className="text-center d-flex flex-column min-vh-100 mb-3">
          <Card bg="dark" text="white" className="border-0 p-5">
            ...
            <Card.Text className="mb-5">
              ...
              out to get them on the geese and giving them the opportunity to
              bag a few.
              <br />
              <br />
            ...
            <Card.Text>
              ...
              and preparing the meat, I could never thank him enough for
              teaching me all I know.
              <br />
              <br />
              I enjoy getting to know all the new people and taking them out to
              experience our way of hunting. Getting to show people what we do
              and how we do it will always be our passion.
              <br /> <br />
              We are always looking forward to teaching others not only a great
              time but a safe time as well. Be sure to get a hold of us, you
              will not regret it!
            </Card.Text>
          </Card>
        </Container>
